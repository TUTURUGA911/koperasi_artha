      ...
      success: function (response) {
        if (response["result"] == "success") {
          if(!response.data['blocked']){
            ...
            let redirectUrl = '';
            let successMessage = "Anda berhasil login!";
            if(response.data['level'] === 2){
              redirectUrl = "/home";
              successMessage += " " + response.data['profilename'];
...
function register() {
    ...
    let inputNIK = $('#form-nik');
    let inputFullName = $('#form-fullname');
    let inputBirthdate = $('#form-birthdate');
    let inputPhone = $('#form-phone');
    let inputGender = $('#form-gender');
    ...
    if (password === "") {
        ...
        helpPassword
            .text("Masukkan password dengan 8-10 karakter, angka, atau spesial karakter (!@#$%^&*)")
            .removeClass("text-dark")
            .addClass("text-danger");
        inputPassword.focus();
        return;
    ...
    if (password2 === "") {
        ...
        $('#fg-password2')
            ...
            .addClass('mb-1');
        helpPassword2
            .text("Masukkan password yang sama dengan sebelumnya!")
            .removeClass("text-dark")
            .addClass("text-danger");
        inputPassword2.focus();
        return;
...
function showUsernameRequirementPopup() {
  Swal.fire({
    icon: 'info',
    title: 'Perhatian',
